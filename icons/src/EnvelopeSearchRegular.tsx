...
export const EnvelopeSearchRegular = ({ className, ...props }: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props} className={className}>
  <path fill="currentColor" fillOpacity=".45" d="M12.75 19a.75.75 0 0 1-.75.75H5c-2.418 0-3.75-1.332-3.75-3.75V7c0-2.418 1.332-3.75 3.75-3.75h12c2.418 0 3.75 1.332 3.75 3.75v4a.75.75 0 0 1-1.5 0V7c0-1.577-.673-2.25-2.25-2.25H5c-1.577 0-2.25.673-2.25 2.25v9c0 1.577.673 2.25 2.25 2.25h7a.75.75 0 0 1 .75.75Zm3.31-11.606-4.913 3.572a.25.25 0 0 1-.293 0L5.942 7.394a.75.75 0 0 0-.883 1.213l4.912 3.572a1.748 1.748 0 0 0 2.058 0l4.912-3.572a.75.75 0 0 0-.882-1.213Zm6.47 14.136a.748.748 0 0 1-1.06 0l-1.55-1.549a3.641 3.641 0 0 1-2.003.602 3.67 3.67 0 0 1-3.667-3.666 3.671 3.671 0 0 1 3.667-3.667 3.67 3.67 0 0 1 3.666 3.667c0 .74-.224 1.427-.603 2.003l1.55 1.549a.75.75 0 0 1 0 1.061Zm-4.613-2.447a2.169 2.169 0 0 0 2.166-2.166 2.17 2.17 0 0 0-2.166-2.167 2.17 2.17 0 0 0-2.167 2.167 2.17 2.17 0 0 0 2.167 2.166Z"/>
</svg>
);
