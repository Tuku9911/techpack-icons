...
export const MenuRightFilled = ({ className, ...props }: any) => (
  ...
  <path fill="currentColor" d="M2 6a1 1 0 0 1 1-1h18a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1Zm19 5H3a1 1 0 0 0 0 2h18a1 1 0 0 0 0-2Zm0 6h-9a1 1 0 0 0 0 2h9a1 1 0 0 0 0-2Z"/>
</svg>
);
